...
const HeroBanner = () => {
  ...
  if (!movies.length)
    return <div style={{ height: 320, background: "var(--black2)" }} />;
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(to right, rgba(10,10,10,0.97) 0%, rgba(10,10,10,0.65) 50%, rgba(10,10,10,0.1) 100%)",
        }}
      />
      <div
        style={{
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <button
            ...
            style={{
              ...
              color: wl ? "var(--maroon-light)" : "var(--text)",
        ...
        {movies.map((_, i) => (
          <button
            ...
            style={{
              ...
              background: i === idx ? "#b8001e" : "var(--text3)",
              border: "none",
              cursor: "pointer",
              padding: 0,
              transition: "all 0.3s",
